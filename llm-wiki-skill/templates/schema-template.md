...
| 来源 | raw 目录 | 提取方式 |
|------|----------|----------|
| 网页文章 | `raw/03_Resources/` | baoyu-url-to-markdown skill |
| X/Twitter | `raw/03_Resources/` | baoyu-url-to-markdown skill（需 Chrome 登录） |
| 微信公众号 | `raw/03_Resources/` | wechat-article-to-markdown |
| YouTube | `raw/03_Resources/` | youtube-transcript skill |
| 小红书 | `raw/03_Resources/` | 用户手动粘贴内容 |
| 知乎 | `raw/03_Resources/` | 用户手动粘贴内容 或 baoyu-url-to-markdown skill |
| PDF / 本地 PDF | `raw/02_Areas/` | 直接读取 |
| Markdown/文本/HTML | `raw/02_Areas/` | 直接读取 |
| 纯文本粘贴 | `raw/02_Areas/` | 直接使用 |
