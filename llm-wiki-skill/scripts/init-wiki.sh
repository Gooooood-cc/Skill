...
# 创建目录结构（包含小红书和知乎）
mkdir -p "$WIKI_ROOT"/raw/{01_Projects,02_Areas,03_Resources,04_Archives,05_Assets}
...
echo "   $WIKI_ROOT/"
echo "   ├── raw/        （原始素材）"
echo "   │   ├── 01_Projects/      进行中的项目"
echo "   │   ├── 02_Areas/         长期关注的事项（PDF、本地文档、纯文本）"
echo "   │   ├── 03_Resources/      外部资源（网页、公众号、知乎、推文、小红书等）"
echo "   │   ├── 04_Archives/       已完成或不再关注的归档"
echo "   │   └── 05_Assets/        图片等附件"
echo "   ├── wiki/       （知识库）"
echo "   ├── index.md    （索引）"
echo "   ├── log.md      （日志）"
